...
@section('content')
    ...
    <div class="text-center text-truncate mt-5">
        <h2 class="" style="font-weight: bold;font-family: serif;">FSc Pre-Engineering
        </h2>
        <hr style="width:12%;border-top:3px solid red;margin-left:590px" class="text-center  mt-5">
        <p class="mt-5 mb-5">
            F.Sc Pre-Engineering is a pre-requisite for future Engineers and Technocrats. Our comprehensive study plan<br> is executed by the most experienced teachers who ensure our students’ great educational success.</p>
    </div>
    <hr class="mt-5">
...
@endsection
@section('title','FSc Pre-Engineering')
@section('nava','active')
